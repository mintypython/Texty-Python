///@function texty_create_width(text, width, ?stylesheet)
///@arg text
///@arg width
///@arg ?stylesheet
...
Accepts a width argument and fits the text within that width
...
texty_apply_width(texty, argument[1]);
return texty;